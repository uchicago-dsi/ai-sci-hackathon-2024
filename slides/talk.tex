  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{exampleblock}{Organizing Team}
        Aditya, Anthony, Chris, Colm, Georgios, Jordan, Ludwig, Mark, Ritesh, Simona
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.4\textwidth}
      {\small\url{github.com/uchicago-dsi/ai-sci-hackathon-2024}}
      \begin{figure}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.45\textwidth}
        Anthony, Georgios, Peter, \& Colm
    \end{column}
    \begin{column}{0.45\textwidth}
      Aditya, Jordan, Chris, Adam, Ritesh, Stephan, Yihang, \& Ludwig
    \end{column}
  \end{columns}
  \begin{columns}
    \begin{column}{0.45\textwidth}
